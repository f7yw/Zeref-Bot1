...
handler.customPrefix = /^([1-9]|1[0-9]|[١-٩]|١[٠-٩]|[۱-۹]|۱[۰-۹]|🎓 التعلم والدراسة|📖 القرآن الكريم|🤖 الذكاء الاصطناعي|🎮 الألعاب|🛠️ أدوات نافعة|💰 الاقتصاد|👤 الحساب والمعلومات|🎧 الوسائط والتحميل|📌 الإنتاجية والتنظيم|📊 التحليل والإحصاءات|🛡️ السلامة والخصوصية|💻 البرمجة والمطور|🌱 الصحة والعادات|👥 إدارة القروب|👑 أوامر المالك|📜 كل الأقسام)$/

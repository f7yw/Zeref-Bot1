...
const sections = {
  ...
  10: {
    title: '🔧 تحكم متقدم بالبوت',
    commands: [
      'تحكم_البوت    ← لوحة كاملة للتحكم بالبوت',
      '',
      '─── معلومات ───',
      'وقت_التشغيل   ← وقت التشغيل + RAM',
      'رام            ← استخدام الذاكرة',
      ...
      'تغيير_البادئة [رمز]  ← تغيير البادئة',
      ...
      'جميع_الخصوصية   [كل/جهات/لا_أحد] ← تغيير الكل',
      '',
      '─── الحساب ───',
      'نشر_حالة [نص]        ← نشر حالة واتساب',
      'حضور_دائم            ← ظهور دائم متاح',
      'حضور_إيقاف           ← إيقاف الحضور',

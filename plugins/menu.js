...
${p}كلمة       ⟵ رتب كلمة تعليمية
${p}سرعة       ⟵ حساب سريع
${p}ذاكرة      ⟵ لعبة ذاكرة أرقام
${p}حل         ⟵ حل الألعاب التعليمية
...
${p}اغنيه صوت اسم      ⟵ إرسال أغنية كصوت
${p}اغنيه فيديو اسم    ⟵ إرسال الأغنية كفيديو
${p}فيديو اسم          ⟵ تحميل فيديو من يوتيوب
${p}بحث_يوتيوب كلمة    ⟵ نتائج بحث مختصرة
${p}ميديا              ⟵ شرح أوامر الوسائط`.trim()
  },
  productivity: {

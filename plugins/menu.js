...
const sections = {
  ...
  8: {
    ...
    commands: [
      ...
      'رفع         ← رفع لمشرف',
      'خفض         ← خفض مشرف',
      'قفل_القروب  ← قفل المجموعة',
      'فتح_القروب  ← فتح المجموعة',
      'منشن_مخفي  ← منشن مخفي',
      'منشن_ظاهر  ← منشن ظاهر',
      'اسم_القروب  ← تغيير اسم المجموعة',
      'وصف_القروب ← تغيير الوصف',
      'صورة_القروب ← عرض صورة المجموعة',
      'تغيير_صورة_القروب ← تغيير الصورة',
      'الحماية     ← حماية المجموعة',
      'حماية_الكلام ← تصفية الكلام',
      'تحذير       ← تحذير عضو',
      'تحذيرات     ← عرض التحذيرات',
      'تنظيف       ← حذف رسائل البوت',
      'احصائيات_القروب ← إحصائيات المجموعة',
    ]
  },
  9: {
    title: '👑 أوامر المالك',
    commands: [
      ...
      'الغاء_بان   ← رفع الحظر',
      'banchat      ← حظر مجموعة',
      'unbanchat    ← رفع حظر مجموعة',
      'انضم         ← انضمام لمجموعة',
      'إعادة        ← إعادة تشغيل البوت',
      'نسخة_احتياطية ← نسخة احتياطية',
      'حالة_البوت  ← حالة البوت',
      'تشغيل       ← تفعيل البوت في المجموعة',
      'ايقاف       ← إيقاف البوت في المجموعة',
      'اخطاء       ← سجل الأخطاء الأخيرة',
      'مسح_المستخدمين ← مسح بيانات المستخدمين',
      'قاعدة_البيانات ← معلومات قاعدة البيانات',
    ]
  }
}

...
const sections = {
  ...
  2: {
    ...
    commands: [
      ...
      'مواعيد_الصلاة [مدينة] ← أوقات الصلاة الخمس',
  ...
  8: {
    ...
    adminCommands: [
      ...
      'قائمه_الصامتين [عدد] ← الأقل نشاطاً (للمراجعة)',
      'تنبيه <نص>           ← إعلان رسمي مزخرف للجميع',
      'كلمة_اليوم <نص>      ← حفظ اقتباس/قاعدة اليوم',
      'قاعدة_القروب         ← عرض كلمة/قاعدة اليوم',
    ]
  },
  ...
  9: {
    ...
    commands: [
      ...
      'احصائيات_شاملة         ← تقرير شامل (ذاكرة، قروبات، مستخدمون)',
      'مغادرة_قروب [jid]      ← يغادر البوت قروباً محدداً',
      'قائمة_المحظورين_عام   ← كل المحظورين (bans + blocks)',
      'تنفيذ_جس <code>        ← تنفيذ JS مباشر (eval)',
      '',
      '─── ربط الهوية ───',
